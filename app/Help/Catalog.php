        ...
        $tours = [
            'pos.create' => [
                [
                    ...
                    'body' => 'Search by name, phone, or email. If they are new, click <strong>+ Add</strong> — name and phone is enough to make a record on the spot.',
                ],
                [
                    'selector' => '#customer_account_info',
                    'title' => 'Store Credit Shows Here',
                    'body' => 'Once a customer is selected, their store-credit balance, gift cards, and lifetime spend show up. The old Google Sheet is no longer the source of truth — credit lives on the customer record.',
                ],
                [
                ...
                [
                    'selector' => '#pos-finalize',
                    'title' => 'Mixed Payment? Use Finalize',
                    'body' => 'For split payments — partial store credit + cash, or any other mix — use the <strong>Finalize</strong> button. For straight cash or card, the buttons above are quicker.',
                ],
                [
                    'selector' => null,

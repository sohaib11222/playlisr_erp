 ...
 * item's status (OK / Low / Out) and the next expected restock. Stored in
 * storage/app/supplies.json (no migration). The help assistant reads this so
 * staff can ask "are we low on waters?" or "when's the next shipment?".
 */
class SuppliesController extends Controller
{
    ...
    const DEFAULT_ITEMS = [
        ['name' => 'Bottled water',        'status' => 'ok', 'next_restock' => '', 'note' => ''],
        ['name' => 'Shopping bags',        'status' => 'ok', 'next_restock' => '', 'note' => ''],
        ['name' => 'Receipt paper rolls',  'status' => 'ok', 'next_restock' => '', 'note' => ''],
        ['name' => 'Label paper / rolls',  'status' => 'ok', 'next_restock' => '', 'note' => ''],
        ['name' => 'Record sleeves',       'status' => 'ok', 'next_restock' => '', 'note' => ''],
        ['name' => 'Mailers / boxes',      'status' => 'ok', 'next_restock' => '', 'note' => ''],
        ['name' => 'Cleaning kits',        'status' => 'ok', 'next_restock' => '', 'note' => ''],
    ];

        ...
        return [
            ...
            'inventory' => [
                ...
                'reports' => [
                    ...
                    ['key' => 'abc-inventory',         'name' => 'Markdown List', 'icon' => 'fa-tags',  'action' => 'ReportController@abcInventoryClassification', 'desc' => 'Slow movers to mark down 30% to clear, by genre and store.'],
                    ['key' => 'abc-import',            'name' => 'ABC Import',            'icon' => 'fa-upload',             'action' => 'AbcImportController@index',                   'desc' => 'Upload monthly sales-based ABC CSV.'],
            ...
            'reconciliation' => [
                ...
                'reports' => [
                    ...
                    ['key' => 'ebay-sales',            'name' => 'eBay Sales',            'icon' => 'fa-gavel',              'action' => 'ReportController@ebayReport',                 'desc' => 'eBay revenue, profit, daily + top items.', 'admin_only' => true],
                    ...
                    ['key' => 'cash-deposits',         'name' => 'Cash Deposits',         'icon' => 'fa-envelope',           'action' => 'CashDepositsReportController@index',          'desc' => 'Safe-drop log — deposit # + cashier, time, amount per envelope.', 'admin_only' => true],
            ...
            'people' => [
                ...
                'reports' => [
                    ...
                    ['key' => 'customer-capture',      'name' => 'Customer Capture Rate', 'icon' => 'fa-id-card',            'action' => 'ReportController@customerCaptureReport',      'desc' => '% of each cashier\'s in-store sales that got a Nivessa account attached, plus why customers weren\'t signed up.', 'admin_only' => true],

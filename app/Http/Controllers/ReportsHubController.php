        ...
        return [
            ...
            'inventory' => [
                ...
                'reports' => [
                    ...
                    ['key' => 'abc-inventory',         'name' => 'ABC Inventory Classification', 'icon' => 'fa-layer-group',  'action' => 'ReportController@abcInventoryClassification', 'desc' => 'Sales-based ABC when imported; live inventory-value fallback.'],

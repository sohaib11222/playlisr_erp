            ...
            if ($request->hasFile('products_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if ($product_array['type'] == 'single') {
                        ...
                        $var_images = [];
                        if (!empty($var_imgs)) {
                            $var_images = array_map('trim', explode(
                            '|',
                                $var_imgs
                            ));
                        }
                        ...
                        foreach ($var_images as $var_image) {
                            ...
                            $product_array['variation']['image'] = $var_image;
                        }
                        ...
                        foreach ($variation_values as $k => $v) {
                            ...
                            $product_array['variation']['variations'][] = [
                                ...
                                'image' => !empty($var_images[$k]) ? $var_images[$k] : '',
                            ];
                        }
                    ...
                    foreach ($formated_data as $index => $product_data) {
                        ...
                        if (!empty($imported_data[$index][36])) {
                            ...
                            foreach ($locations_array as $business_location) {
                                ...
                                $product->product_locations()->sync([1,2]);
                        }


                        //Create single product variation
                        if ($product->type == 'single') {
                            $this->productUtil->createSingleImportProductVariation(
                            ...
                            $this->productUtil->createVariableImportProductVariations(
                                $product,
                                [$variation_data],
                                $business_id
                            );

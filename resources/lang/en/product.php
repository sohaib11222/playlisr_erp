...
return [
    ...
    */
    ...
    'mass_add_new_products' => 'Mass add new products',
    ...
    'current_stock_updated' => 'Current stock updated successfully',
    'set_current_stock' => 'Set current stock',
    'set_current_stock_help' => 'Set the quantity on hand per location. This overwrites the current quantity (unlike Opening Stock which adds).',
    'set_to_quantity' => 'Set to',
    'set_current_stock_no_values' => 'No stock values were updated. Ensure the product has locations assigned and you entered quantities.',

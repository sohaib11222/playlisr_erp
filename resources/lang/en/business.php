...
return [
    ...
    */
    ...
    'database_backup_heading' => 'Database backup',
    'database_backup_intro' => 'Create a full SQL dump of the application database (MySQL only). Only business Admins can create and download backups. Old backups are removed automatically when more than :count files exist.',
    'database_backup_create' => 'Create backup now',
    'database_backup_refresh_list' => 'Refresh list',
    'database_backup_download' => 'Download',
    'database_backup_created' => 'Backup created successfully.',
    'database_backup_none' => 'No backups yet. Create one to get started.',
    'database_backup_requires_mysql' => 'Backups require MySQL. Your environment uses a different database driver.',
    'database_backup_admin_only' => 'Only the business Admin role can use database backups.',
    'database_backup_col_file' => 'File',

            ...
            <div class="as-task-body">
                ...
                <div class="as-fields">
                    ...
                    <div class="v">
                        ...
                        <label style="font-weight:400;font-size:13px;margin:0 0 0 6px;"><input type="hidden" name="no_due_date" value="0"><input type="checkbox" name="no_due_date" value="1" @if(old('no_due_date', $task->no_due_date)) checked @endif> No due date</label>
                    </div>

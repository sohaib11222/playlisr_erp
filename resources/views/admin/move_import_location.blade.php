...
<section class="content-header">
    ...
    <p class="text-muted" style="max-width:920px;">
        ...
        undo at <a href="/admin/admin-action-history">admin-action-history</a>. Live POS is untouched.
    </p>
</section>
    ...
    <form method="POST" action="/admin/move-import-location/run">
        ...
        <div class="box box-solid">
            ...
            <div class="box-body table-responsive">
                <p>
                    <a href="#" onclick="document.querySelectorAll('.grp').forEach(function(c){c.checked=true});return false;">Select all</a> ·
                    <a href="#" onclick="document.querySelectorAll('.grp').forEach(function(c){c.checked=false});return false;">Select none</a> ·
                    <a href="#" onclick="document.querySelectorAll('.grp').forEach(function(c){c.checked=(c.getAttribute('data-pre')==='1')});return false;">Pre-cutoff only</a>
                </p>

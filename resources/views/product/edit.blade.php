...
<style>
/* ============ PRODUCT EDIT V2 — matches /pos/create theme ============ */
.product-edit-v2 {
    --pe-bg:          #FAF6EE;
    --pe-surface:     #FFFFFF;
    --pe-surface-2:   #F7F1E3;
...
.product-edit-v2 .help-block { font-size: 12px; color: var(--pe-ink-3); margin-top: 4px; }
...
.product-edit-v2 .bg-purple { background: var(--pe-accent-soft) !important; color: var(--pe-accent-text) !important; border-color: var(--pe-accent-deep) !important; }
.product-edit-v2 .bg-maroon { background: #8A3A2E !important; color: #fff !important; border-color: #8A3A2E !important; }
.product-edit-v2 .btn-warning { background: var(--pe-accent) !important; color: var(--pe-accent-text) !important; border-color: var(--pe-accent-deep) !important; }
...
.product-edit-v2 .table > thead > tr > th {
    ...
    border-bottom: 2px solid var(--pe-line-2) !important;
    text-transform: uppercase; letter-spacing: .04em; font-size: 11px;
    font-weight: 700; color: var(--pe-ink-3); padding: 12px 14px;
}
.product-edit-v2 .table > tbody > tr > td {
    padding: 12px 14px; border-color: var(--pe-line); vertical-align: middle;
}

.product-edit-v2 .pe-action-bar {
    background: var(--pe-surface);
    border: 1px solid var(--pe-line);
    border-radius: var(--pe-radius);
...
.product-edit-v2 .pe-action-bar .btn { padding: 11px 22px; font-size: 15px; }
</style>
...
{!! Form::open(['url' => action('ProductController@update' , [$product->id] ), 'method' => 'PUT', 'id' => 'product_add_form',
    ...
    {{-- ─── Card 2: Cost & Selling Price (moved up) ──────────────────── --}}
    <div class="pe-card">
...
{{-- ─── Card 3: Set Current Stock (moved up — own form, AJAX) ──────── --}}
...
{{-- ─── Card 4: Description (moved to bottom) ───────────────────────── --}}
<div class="pe-card">
    ...
    {!! Form::textarea('product_description', $product->product_description, ['class' => 'form-control', 'form' => 'product_add_form']) !!}
</div>
...
<div class="pe-action-bar">
    ...
    <button type="submit" form="product_add_form" value="save_n_add_another" class="btn bg-maroon submit_product_form">@lang('lang_v1.update_n_add_another')</button>

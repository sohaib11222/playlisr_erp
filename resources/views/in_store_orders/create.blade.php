...
@section('title', 'Add In Store Order')
...
{!! Form::open(['action' => 'InStoreOrderController@store', 'method' => 'post', 'id' => 'order_form']) !!}
<div class="pickup-wrap">
    <h1>Add In Store Order</h1>
    <p class="sub">Log a walk-in order — who it's for, what it is, and whether they've paid. Notify them from the list once it's ready.</p>
    ...
    <div class="pickup-card">
        ...
        <div class="pickup-row">
            <div class="pickup-field" style="flex: 2 1 260px;">
                ...
                {!! Form::text('customer_name', null, ['class' => 'form-control', 'required', 'placeholder' => 'Full name']); !!}
            </div>
            <div class="pickup-field">
                {!! Form::label('location_id', 'Store') !!}
                {!! Form::select('location_id', $locations, null, ['id' => 'location_id', 'class' => 'form-control select2', 'placeholder' => 'Select store', 'style' => 'width: 100%']); !!}
            </div>
        </div>
        <div class="pickup-row" style="margin-top: 4px;">
            <div class="pickup-field">
                {!! Form::label('customer_phone', 'Phone') !!}
                {!! Form::text('customer_phone', null, ['class' => 'form-control', 'placeholder' => '(555) 123-4567', 'maxlength' => 40]); !!}
            </div>
            <div class="pickup-field">
                {!! Form::label('customer_email', 'Email') !!}
                {!! Form::email('customer_email', null, ['class' => 'form-control', 'placeholder' => 'name@email.com']); !!}
            </div>
        </div>
        <small class="help-block">Phone/email are used to notify the customer when the order's ready — fill in at least one if you'll want to notify them later.</small>
    </div>
    ...
    <div class="pickup-card">
        ...
        <div class="pickup-row">
            <div class="pickup-field" style="flex: 2 1 260px;">
                ...
                {!! Form::text('item_name', null, ['class' => 'form-control', 'required', 'placeholder' => 'Artist — Title']); !!}
            </div>
            <div class="pickup-field narrow">
                {!! Form::label('price_paid', 'Price Paid') !!}
                <div class="input-group">
                    <span class="input-group-addon">$</span>
                    {!! Form::number('price_paid', null, ['class' => 'form-control', 'step' => '0.01', 'min' => '0', 'placeholder' => '0.00']); !!}
                </div>
            </div>
        </div>
        <div class="pickup-row" style="margin-top: 12px;">
            <div class="pickup-field" style="flex: 1 1 100%;">
                <div class="pickup-check">
                    {!! Form::checkbox('is_paid', 1, false, ['id' => 'is_paid']) !!}
    ...
    <div class="pickup-card">
        ...
        {!! Form::textarea('notes', null, ['class' => 'form-control', 'rows' => 3, 'placeholder' => 'Optional']); !!}
    </div>

    <div class="pickup-actions">
        <a href="{{ action('InStoreOrderController@index') }}" class="btn-ghost">Cancel</a>
        <button type="submit" class="btn-accent">Save Order</button>
    </div>
</div>
{!! Form::close() !!}

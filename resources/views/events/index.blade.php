...
<div class="ev-wrap ev-wrap-wide">
  <div class="ev-head">
    <div>
      ...
      <div style="display:flex;gap:8px;margin-top:10px;flex-wrap:wrap;">
        ...
        <a href="{{ action('CustomerPickupController@index') }}#preorders" style="{{ $tabBase }}{{ $tabOff }}">Preorders &rarr;</a>
  ...
  @if(!empty($debugToOrderDump))
    <pre style="white-space:pre-wrap;background:#eee;padding:10px;font-size:11px;">{{ json_encode($debugToOrderDump, JSON_PRETTY_PRINT) }}</pre>
  @endif

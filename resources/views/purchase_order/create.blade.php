...
{{-- POS-create (pos-v2) reskin. Pure CSS overlay scoped to body.pos-v2 — the
     form structure, element IDs and purchase.js behaviour are untouched. --}}
...
body.pos-v2 .content .form-control { border:1px solid var(--pos-line-2); border-radius:9px; box-shadow:none; height:auto; padding:9px 11px; font-family:inherit; color:var(--pos-ink); }
...
body.pos-v2 .content .input-group-btn .btn { border-radius:0 9px 9px 0; border:1px solid var(--pos-line-2); }

/* select2 */
body.pos-v2 .select2-container--default .select2-selection--single { border:1px solid var(--pos-line-2); border-radius:9px; height:40px; }
body.pos-v2 .select2-container--default .select2-selection--single .select2-selection__rendered { line-height:38px; }
body.pos-v2 .select2-container--default .select2-selection--single .select2-selection__arrow { height:38px; }
...
body.pos-v2 #submit_purchase_form { padding:11px 26px; font-size:15px; }
body.pos-v2 .content .btn-link { color:var(--pos-accent-text); font-weight:600; }

/* product entry table */
body.pos-v2 #purchase_entry_table thead th { background:var(--pos-surface-2); color:#5a5145; text-transform:uppercase; font-size:11px; letter-spacing:.04em; border-color:var(--pos-line)!important; }
body.pos-v2 #purchase_entry_table td, body.pos-v2 #purchase_entry_table th { border-color:var(--pos-line)!important; vertical-align:middle; }
</style>

        ...
        <div class="col-md-9">
            @component('components.widget', ['class' => 'box-primary', 'title' => $article->title])
                ...
                <p class="text-muted small">
                    Last updated: {{ $article->updated_at ? $article->updated_at->format('M d, Y') : '—' }}
                    &middot;
                    See something wrong? <a href="mailto:sarah@nivessa.com?subject=Handbook%20fix:%20{{ urlencode($article->title) }}">Email Sarah</a>
                </p>
            @endcomponent
        </div>
        <div class="col-md-3">

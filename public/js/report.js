$(document).ready(function() {
    ...
    register_report_table = $('#register_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'opening_balance', name: 'opening_balance', searchable: false, orderable: false },
    ...
    items_report_table = $('#items_report_table').DataTable({
        ...
        columns: [
            ...
            { data: 'sku', name: 'v.sub_sku', visible: false },
            { data: 'category', name: 'cat.name' },
            { data: 'sub_category', name: 'sub_cat.name' },
            { data: 'sell_line_note', name: 'SL.sell_line_note', visible: false },
            { data: 'purchase_date', name: 'purchase.transaction_date' },
            { data: 'purchase_ref_no', name: 'purchase.ref_no' },
            { data: 'lot_number', name: 'PL.lot_number', visible: false },
            { data: 'supplier', name: 'suppliers.name', visible: false },

...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/home/fastest-sellers', 'HomeController@fastestSellersDetail')->name('home.fastestSellers');
    ...
    Route::post('/products/check-duplicate', 'ProductController@checkDuplicate')->name('products.checkDuplicate');
    ...
    Route::get('/admin/sku-correction', 'ProductController@skuCorrectionPage')->name('products.skuCorrection');
    Route::post('/admin/sku-correction/apply', 'ProductController@applySkuCorrection')->name('products.applySkuCorrection');
    ...
    Route::post('/buy-from-customer/{id}/storage-location', 'BuyFromCustomerController@updateStorageLocation')->name('buy-from-customer.storage-location.update');
    Route::post('/buy-from-customer/{id}/processing-status', 'BuyFromCustomerController@updateProcessingStatus')->name('buy-from-customer.processing-status.update');
    ...
    Route::get('/sells/pos/get-related-artists', 'SellPosController@getPosRelatedArtists');
    ...
    Route::get('/reports/inventory-check-assistant/seasonal-bucket', 'InventoryCheckController@seasonalBucket');
    Route::get('/reports/inventory-check-assistant/accessories-bucket', 'InventoryCheckController@accessoriesBucket');
    ...
    Route::post('/reports/inventory-check-assistant/supplier-credentials', 'InventoryCheckController@saveSupplierCredentials');
    ...
    Route::get('/reports/inventory-check-assistant/wizard-progress', 'InventoryCheckController@wizardProgress');
    Route::post('/reports/inventory-check-assistant/wizard-progress', 'InventoryCheckController@setWizardProgress');
    ...
    Route::get('/reports/archer-performance/filtered', 'ReportController@archerPerformanceFiltered')->name('reports.archer-performance.filtered');
    ...
    // My Tasks: Asana-style personal list (everyone).
    ...
    Route::get('/admin/admin-action-history/artist-fills', 'AdminActionHistoryController@artistFills');
    ...
    Route::get('/admin/clover-hw-breakdown', 'CloverHwBreakdownController@index');
...
Route::middleware(['setData', 'auth', 'SetSessionData'])->group(function () {
    Route::post('help-assistant/message', 'HelpAssistantController@message')->name('help-assistant.message');
});
